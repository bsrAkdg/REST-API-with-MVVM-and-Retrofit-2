...
/**
 * https://stackoverflow.com/a/37741873/4133130
 */
public class HorizontalDottedProgress extends View {
    ...
    private void createDot(Canvas canvas, Paint paint) {
        //here i have setted progress bar with 10 dots , so repeat and wnen i = mDotPosition
        // then increase the radius of dot i.e mBounceDotRadius
